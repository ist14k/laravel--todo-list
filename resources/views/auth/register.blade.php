<x-layouts.app>
  ...
  <div class="mb-8 border-b-2 border-gray-300 pb-4">
    ...
    <p class="mt-2 text-gray-600">Join us today! Create your account to get started</p>
  </div>

  <!-- Registration Form -->
  <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-lg">
    <form action="{{ route('register.register') }}" method="POST" class="space-y-6">
      @csrf
      <!-- Name Field -->
      <div>
        <label for="name" class="block text-sm font-medium text-gray-800">Full Name</label>
        <input type="text" id="name" name="name" required
          class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-3 text-lg text-gray-800 placeholder-gray-500 focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500"
      ...
      <!-- Submit Button -->
      <button type="submit"
        class="w-full rounded-lg bg-gray-800 px-6 py-3 font-medium text-white transition-colors hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500">
        Create Account
      </button>
    </form>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
      <button type="button"
        class="flex items-center justify-center gap-3 rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500">
