<x-layouts.app>
  ...
  <div class="space-y-2.5">
    <!-- Completed Task -->
    <div
      class="group flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3 transition-all hover:shadow-sm">
      <input type="checkbox" checked class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
      <p class="flex-1 text-base text-gray-500 line-through">Complete project documentation</p>
    ...
    <div
      ...
      <input type="checkbox" class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
      <p class="flex-1 text-base text-gray-700">Review code changes</p>
      <div class="flex gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
        <button
          class="rounded px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200 hover:text-gray-800">Edit</button>
        <button
    ...
    <div
      class="group flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3 transition-all hover:shadow-sm">
      <input type="checkbox" class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
      <p class="flex-1 text-base text-gray-700">Update user interface</p>
      <div class="flex gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
        <button
          class="rounded px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200 hover:text-gray-800">Edit</button>
        <button
    ...
    <div
      class="group flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3 transition-all hover:shadow-sm">
      <input type="checkbox" checked class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
      <p class="flex-1 text-base text-gray-500 line-through">Set up development environment</p>
      <div class="flex gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
        <button
          class="rounded px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200 hover:text-gray-800">Edit</button>
        <button
    ...
    <div
      class="group flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3 transition-all hover:shadow-sm">
      <input type="checkbox" class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
      <p class="flex-1 text-base text-gray-700">Prepare presentation slides</p>
      <div class="flex gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
        <button
          class="rounded px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200 hover:text-gray-800">Edit</button>
        <button
